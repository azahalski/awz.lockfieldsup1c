...
use Awz\Lockfieldsup1c\Access\Custom\ActionDictionary;
...
$aMenu[] = array(
    ...
    "sort" => 100,
    "module_id" => $module_id,
    "text" => Loc::getMessage('AWZ_ADMIN_MENU_NAME_AWZ_LOCKFIELDSUP1C'),
    "title" => Loc::getMessage('AWZ_ADMIN_MENU_NAME_AWZ_LOCKFIELDSUP1C'),
