...
use Awz\Lockfieldsup1c\Access\Custom;
use Awz\Lockfieldsup1c\Access\AccessController;
use Awz\Lockfieldsup1c\Access\Permission\RoleUtil;
use Awz\Lockfieldsup1c\Access\Permission\ActionDictionary;

Loc::loadMessages(__FILE__);

class AdminConfigPermissionsAjaxController extends Controller
{
    const MODULE_ID = 'awz.lockfieldsup1c';
