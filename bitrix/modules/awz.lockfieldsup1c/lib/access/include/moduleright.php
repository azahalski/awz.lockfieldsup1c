...
use Awz\Lockfieldsup1c\Access\Custom\ComponentConfig;
                ...
                window.awz_right_dialog = {
                    ...
                    reloadItems: function(items, event){
                        ...
                        items.forEach(function(itm){
                            if(itm.getEntityId()==='user' || itm.getEntityType()==='awzlockfieldsup1c-user'){
                                let itmEv = {
                                    type: 'users',
                                    id: 'U'+itm.getId(),
                                    key: 'U'+itm.getId(),
                            ...
                            }else if(itm.getEntityType()==='awzlockfieldsup1c-group'){
                                let itmEv = {
                                    type: 'groups',
                                    id: 'G'+itm.getId(),
                                    key: 'G'+itm.getId(),
                    ...
                    load: function(groupKey, options){
                        ...
                        if(groupData.hasOwnProperty('members')){
                            for(k in groupData['members']){
                                ...
                                if(itm.type==='users'){
                                    preselectedItems.push(['awzlockfieldsup1c-user',itm.id]);
                                }
                                else if(itm.type==='awzlockfieldsup1c-user'){
                                    preselectedItems.push(['awzlockfieldsup1c-user',itm.id]);
                                }
                                else if(itm.type==='awzlockfieldsup1c-group'){
                                    preselectedItems.push(['awzlockfieldsup1c-group',itm.id]);
                                }
                        ...
                        this.dialog = new BX.UI.EntitySelector.Dialog({
                            ...
                            entities: [
                                {
                                    id: 'awzlockfieldsup1c-user',
                                    options: {},
                                    dynamicLoad: true,
                                    dynamicSearch: true,
                                },
                                {
                                    id: 'awzlockfieldsup1c-group',
                                    options: {},
                                    dynamicLoad: true,
                                    dynamicSearch: true,
                                },
