...
1) Передите на страницу решения в маркетплейс 1с-Битрикс [ссылка](https://marketplace.1c-bitrix.ru/solutions/awz.lockfieldsup1c/)
...
2) Введите код модуля awz.lockfieldsup1c
...
1) Скачайте необходимую версию модуля с github, например, со страницы [releases](https://github.com/zahalski/awz.lockfieldsup1c/releases)
2) Распакуйте архив
3) Загрузите модуль
   
**Если установка в UTF-8 версии**

Скопируйте папку с распакованного архива bitrix\modules\awz.lockfieldsup1c в папку \bitrix\modules\ вашего сайта
...
- Переименовываем папку из .last_version в awz.acl
- Копируем нашу папку dist\awz.acl в папку \bitrix\modules\ вашего сайта
4) Проверяем или все верно
- Вместо awz.module на изображении Ваша папка будет с названием `awz.acl`
...
6) Выбираем модуль с кодом awz.acl и нажимаем установить
